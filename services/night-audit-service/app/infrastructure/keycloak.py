"""Vérification JWT (JWKS Keycloak) + token client_credentials pour les
appels sortants — identique aux autres services (pas de lib partagée, D2)."""
...
async def get_service_token() -> str:
    """Token client_credentials pour les appels sortants vers
    front-office/reservation/analytics/notification (D12)."""
    now = time.time()
