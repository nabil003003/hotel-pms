...
class Settings(BaseSettings):
    ...
    database_url: str = "postgresql+asyncpg://amh:amh_dev_password@localhost:5432/pricing_db"
    ...
    keycloak_client_id: str = "svc-pricing"
    keycloak_client_secret: str = "dev-secret-pricing"
